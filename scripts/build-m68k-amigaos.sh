...
ZZPLAY_SOURCES="tools/zzplay-ahi.c tools/zzplay-audio.c tools/zzplay-audio-clock.c tools/zzplay-core.c tools/zzplay-media.c tools/zzplay-options.c tools/zzplay-probe.c tools/zzplay-stats.c tools/zzplay-stream.c tools/zzplay-sync.c tools/zzplay-video.c tools/zzplay.c"
