...
ZZPLAY_SOURCES="tools/zzplay-ahi.c tools/zzplay-audio.c tools/zzplay-audio-clock.c tools/zzplay-ax.c tools/zzplay-core.c tools/zzplay-launch.c tools/zzplay-media.c tools/zzplay-mhi.c tools/zzplay-mp3.c tools/zzplay-mp3-transport.c tools/zzplay-options.c tools/zzplay-path.c tools/zzplay-probe.c tools/zzplay-stats.c tools/zzplay-stream.c tools/zzplay-sync.c tools/zzplay-video.c tools/zzplay.c"
